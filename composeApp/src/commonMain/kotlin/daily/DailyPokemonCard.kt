...
@Composable
fun DailyPokemonCard(modifier: Modifier, pokemon: Pokemon, maxAttributeValue: Int) {
            ...
            Row(
                ...
                PokemonAttributeChart(
                    ...
                    items = attributes.map { attribute ->
                        when (attribute.kind) {
                            Pokemon.Attribute.Kind.HP -> Res.string.pokemon_attribute_hp

                            Pokemon.Attribute.Kind.SPEED -> Res.string.pokemon_attribute_speed

                            Pokemon.Attribute.Kind.BASIC_ATTACK -> Res.string.pokemon_attribute_basic_attack

                            Pokemon.Attribute.Kind.BASIC_DEFENSE -> Res.string.pokemon_attribute_basic_defense

                            Pokemon.Attribute.Kind.SPECIAL_ATTACK -> Res.string.pokemon_attribute_special_attack

                            Pokemon.Attribute.Kind.SPECIAL_DEFENSE -> Res.string.pokemon_attribute_special_defense
                        } to attribute.value
                    }.map { (name, value) ->
